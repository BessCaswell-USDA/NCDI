...
//	*Description: This program transposes the FNNDS 2011-2012 ingredient nutrient value dataset (SR23) from long to wide; program must run all at once for 'levelsof' command to work properly
...
//	*3. Transpose ingredient nutrient values (program must run all at once for 'levelsof' command to work properly)
		...
		foreach l of local ingredientcode {
			...
			capture noisily replace menaquinone4_0 =		Nutrient_value if SR_code == `l' & Nutrient_code == 428
			capture noisily replace dhphylquinone_0 =		Nutrient_value if SR_code == `l' & Nutrient_code == 429
			...
			capture noisily replace unsatfat18_1n7_0 = 		Nutrient_value if SR_code == `l' & Nutrient_code == 859
		}
		}
	
//	*4. Populate nutrient level variables and drop temporary working variables
		{
		...
		bysort SR_code: egen menaquinone4 = 		mean(menaquinone4_0)
		bysort SR_code: egen dhphylquinone = 		mean(dhphylquinone_0)
		...
		bysort SR_code: egen unsatfat18_1n7 = 		mean(unsatfat18_1n7_0)
		}
